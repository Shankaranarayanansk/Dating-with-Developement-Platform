    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Logical Reasoning</h2>
          <iframe
            width="100%"
            height="315"
        ...
        {/* Verbal Ability */}
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Verbal Ability</h2>
          <iframe
            width="100%"
            height="315"
        ...
        {/* Data Interpretation */}
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Data Interpretation</h2>
          <iframe
            width="100%"
            height="315"
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Analytical Reasoning</h2>
          <iframe
            width="100%"
            height="315"
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Math Tricks</h2>
          <iframe
            width="100%"
            height="315"
        ...
        {/* Problem Solving */}
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Comunicational Skills</h2>
          <iframe
            width="100%"
            height="315"
        ...
        {/* Number Series */}
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Resume Building</h2>
          <iframe
            width="100%"
            height="315"
        ...
        {/* Puzzles and Riddles */}
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Coding Round</h2>
          <iframe
            width="100%"
            height="315"
